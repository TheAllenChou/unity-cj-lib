...
public class CjLibDebugUtilDemo : MonoBehaviour
{
  ...
  private void DrawCircleSegments(Vector3 center)
  {
    ...
    DebugUtil.DrawCircle2D(center + m_basePos, 1.0f, numSegments, Color.white);
  }
  ...
  private void DrawSphereLatSegments(Vector3 center)
  {
    ...
    DebugUtil.DrawSphere(center + m_basePos, m_baseRotQuat, 1.0f, latSegments, 8, Color.white);
  }
  ...
  private void DrawCapsuleLatSegments(Vector3 center)
  {
    ...
    DebugUtil.DrawCapsule(center + m_basePos, m_baseRotQuat, 1.0f, 0.5f, latSegments, 6, Color.white);
  }
